...
- **Data Processing**: Parse headset tracking logs and controller inputs with `Data1/vive_qoe.py` and `Data1/proFiles.py`, clean and filter in `Data1/Processed/`, then extract features and train models via `Data1/ML.ipynb`.  
- **Model Training**: In `husper/`, define reward, DQN/CQL training scripts, configuration files (`husper/configs/`), and Jupyter notebooks for reproducible experiments.  
